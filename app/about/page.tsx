		...
		<div className="flex md:flex-row flex-col min-h-[calc(100vh-89px)] md:min-h-[calc(100vh-64px)]">
			...
			<main className="flex-1 p-4 pb-16 md:ml-[200px] mt-[70px] md:mt-0 overflow-y-auto">
				...
				<div className="text-[clamp(14px,4vw,16px)] leading-relaxed">
					...
					"
					>
						Lors de vos observations en mer, cliquez simplement sur la carte
						pour signaler la présence d&apos;acanthasters. Indiquez le nombre
						d&apos;individus observés et votre niveau de certitude. Ces données
						sont essentielles pour organiser les campagnes d&apos;éradication.
					</p>
				</div>
			</main>
		</div>
